...
public class ReportGenerating_Filtro {
    ...
    public void generateReport(Connection conn, String nombre) {
        try {
            ...
            String sql = "SELECT nombre, tiempo FROM USER WHERE nombre = '" + nombre + "'"; // Filtrar por el nombre variable
    ...
    public static void main(String[] args) {
        ...
        String nombre = "Eliseo";  // Cambia el valor aquí para filtrar por diferentes nombres
